...
import {
  ...
  export default function AppleQuestion2({navigation,route})
  {
    const optionapple21="Red"
    const optionapple22="Darkred"
    const optionapple23="Striped"
        ...
        <View style={[styles.card, styles.shadowProp]}>  
          ...
          <View style={styles.textview}>
            ...
            <Pressable style={styles.boxnumber}>
              ...
              onPress={()=>navigation.navigate('AppleQuestion3',{
                paramKey2:route.params.paramKey1,
                paramKey3:optionapple21
               })}
              >
              ...
              onPress={()=>navigation.navigate('AppleQuestion3',{
                paramKey2:route.params.paramKey1,
                paramKey3:optionapple23
               })}
              >
                    <Text style={styles.text1}>Stripped-pink & yellow</Text>
              </Pressable>
