...
import {
  ...
  export default function AppleQuestion4({navigation,route})
  {
    const optionapple41="yes"
    const optionapple42="no"
        ...
        <View style={[styles.card, styles.shadowProp]}>  
          ...
          <View style={styles.textview}>
            ...
            <Pressable style={styles.boxnumber}>
              ...
              Does the fruit have sweet smell?
              </Text>
